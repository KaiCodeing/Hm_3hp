    ...
    protected void callBackForServerSuccess(HemaNetTask hemaNetTask, HemaBaseResult hemaBaseResult) {
        ...
        switch (information) {
            ...
            case CODE_VERIFY:
                ...
                getNetWorker().password2Reset(temp_token,"1", Md5Util.getMd5(XtomConfig.DATAKEY
                        + Md5Util.getMd5(password)), Md5Util.getMd5(XtomConfig.DATAKEY
                        + Md5Util.getMd5(input_name.getText().toString())));
                break;
            case PASSWORD_RESET:
